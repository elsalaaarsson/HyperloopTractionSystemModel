...
%General values
values = general;
values.tracklength = 67350;     %Bird-fly shortest distance between Edinburgh and Glasgow [m]
...
values.n_passengers = 40;       %Number of passengers per pod
